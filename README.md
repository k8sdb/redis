[![Go Report Card](https://goreportcard.com/badge/kubedb.dev/redis)](https://goreportcard.com/report/kubedb.dev/redis)
![CI](https://github.com/kubedb/redis/workflows/CI/badge.svg)
